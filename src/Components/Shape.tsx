...
const SVGStyle = styled("svg")<SvgProps>(({ theme, bgcolor }) => ({
    fill: bgcolor ?? theme.palette.primary.main,
    width: "72px",
    height: "72px",
}));
...
const Shape = ({
    ...
    return (
        <ShapeSpan>
            <SVGStyle bgcolor={bgcolor} width="100px" height="100px" viewBox="0 0 572 650">
